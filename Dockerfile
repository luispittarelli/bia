...
# Build do front-end com Vite usando URL relativa (mesmo host)
RUN cd client && VITE_API_URL=http://bia-alb-1914883838.us-east-1.elb.amazonaws.com npm run build
